...
func Test_Parse_Cluster_Config_When_Default_Version_And_UpgradeTransition(testCtx *testing.T) {
	...
	expectedClusters.Add(&contexts.Cluster{BackendAddresses: []*net.TCPAddr{serverOne, serverTwo}, RequestCounter: -1, Uuid: uuidGenerator(), SessionTimeout: 0, Mode: contexts.InstantMode, Version: 0.0})
...
func Test_Parse_Cluster_Config_When_Default_Mode(testCtx *testing.T) {
	...
	expectedClusters.Add(&contexts.Cluster{BackendAddresses: []*net.TCPAddr{serverOne, serverTwo}, RequestCounter: -1, Uuid: uuidGenerator(), SessionTimeout: 60, Mode: contexts.SessionMode, Version: 1.0})
...
func Test_Parse_Cluster_Config_When_Config_Valid_No_Defaults(testCtx *testing.T) {
	...
	expectedClusters.Add(&contexts.Cluster{BackendAddresses: []*net.TCPAddr{serverOne, serverTwo}, RequestCounter: -1, Uuid: uuidGenerator(), Mode: contexts.InstantMode, Version: 1.0})
...
func Test_Parse_Cluster_Config_When_Concurrent_Transition_Mode(testCtx *testing.T) {
	...
	expectedClusters.Add(&contexts.Cluster{BackendAddresses: []*net.TCPAddr{serverOne, serverTwo}, RequestCounter: -1, Uuid: uuidGenerator(), Mode: contexts.ConcurrentMode, Version: 1.0})
...
func Test_Parse_Cluster_Config_When_Gradual_Transition_Mode(testCtx *testing.T) {
	...
	expectedClusters.Add(&contexts.Cluster{BackendAddresses: []*net.TCPAddr{serverOne, serverTwo}, RequestCounter: -1, Uuid: uuidGenerator(), Mode: contexts.GradualMode, PercentageTransitionPerRequest: float64(0.01), Version: 1.0})
...
func Test_Parse_Cluster_Config_When_Config_Valid_With_UUID(testCtx *testing.T) {
	...
	expectedClusters.Add(&contexts.Cluster{BackendAddresses: []*net.TCPAddr{serverOne, serverTwo}, RequestCounter: -1, Uuid: uuid.Parse("1027596f-1034-11e4-8334-600308a82410"), Mode: contexts.InstantMode, Version: 1.0})
...
func Test_Serialise_Cluster_When_Instant_Mode(testCtx *testing.T) {
	...
	var (
		...
		cluster *contexts.Cluster = &contexts.Cluster{BackendAddresses: []*net.TCPAddr{serverOne, serverTwo}, Uuid: uuidValue, Mode: contexts.InstantMode, Version: 1.0}
	)
...
func Test_Serialise_Cluster_When_Session_Mode(testCtx *testing.T) {
	...
	var (
		...
		cluster *contexts.Cluster = &contexts.Cluster{BackendAddresses: []*net.TCPAddr{serverOne, serverTwo}, Uuid: uuidValue, SessionTimeout: int64(10), Mode: contexts.SessionMode, Version: 1.0}
	)
...
func Test_Serialise_Cluster_When_Gradual_Mode(testCtx *testing.T) {
	...
	var (
		...
		cluster *contexts.Cluster = &contexts.Cluster{BackendAddresses: []*net.TCPAddr{serverOne, serverTwo}, Uuid: uuidValue, PercentageTransitionPerRequest: float64(0.01), Mode: contexts.GradualMode, Version: 1.0}
	)
...
func Test_Serialise_Cluster_When_Concurrent_Mode(testCtx *testing.T) {
	...
	var (
		...
		cluster *contexts.Cluster = &contexts.Cluster{BackendAddresses: []*net.TCPAddr{serverOne, serverTwo}, Uuid: uuidValue, Mode: contexts.ConcurrentMode, Version: 1.0}
	)
