...
\subsection{Proposed Dynamic Software Update System} 
...
\begin{figure}[!ht]
  \centering
     \includegraphics[scale=0.70]{proposed_solution}
...
\begin{figure}[!ht]
  ...
  \caption{TCP Socket Based Proxy Design Supporting Dynamic Software Update}
  \label{proxy}
\end{figure}
% \vspace{-18pt}
