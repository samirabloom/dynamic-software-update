...
The first version of the socket based proxy was designed as demonstrated in figure \ref{prototype}. The proxy consists of a listener that listens in an  \textit{Accept} loop for new TCP connections. 
