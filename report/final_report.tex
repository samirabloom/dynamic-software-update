...
\subsection{REST API}
To configure the staged proxy and apply different upgrade modes stated in section \ref{modes}, a REST configuration service was implemented and integrated into the staged proxy. 
