...
\subsubsection{Socket Based Proxy With End Of File}
...
\begin{list}{-}{}
  ...
  \item\textbf{Inversion-Of-Control And Dependency Injection} - allowed incremental development of the proxy where new components were plugged-in and configured one by one while existing components all worked together. For the HTTP load balancing proxy shown in figure \ref{proxy} the read and write stages were fist developed and that was followed by development of the complete and routing stages respectively. Furthermore, This design also simplified testing for the following reasons:
\begin{list}{-}{}
  \itemsep0em
...
\noindent
This proxy does not use content counting to detect the end of messages instead it uses the End of File (EOF) signal. This
