...
\begin{figure}[!ht]
  \centering
     \includegraphics[scale=0.70]{proposed_solution_2}
...
\begin{figure}[!ht]
  \centering
     \includegraphics[scale=0.70]{prototype_2}
...
\end{list}
  \item \textbf{Backward Pipe} creates the same stages as the forward pipe for the response. The read stage of the backward pipe reads the response from the server, and the write stage writes the response to the HTTP connection.
\end{list}
