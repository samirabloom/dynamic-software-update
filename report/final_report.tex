...
\noindent\\
\textit{Handling Incorrect Behavior} - To insure the proxy can go back to the older version of the application if the new version behaved incorrectly, the Docker container running the new version (\textit{i.e.} version 3.9.2) of the WordPress application was stopped. The behavior of the proxy was screened when new HTTP requests with transition cookie were sent to it.  
